...
export const QgisIcon: React.FC<QgisIconProps> = ({ size = 24, color = 'currentColor', strokeWidth = 2, className, style, ...props }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <polygon points="68.613,69.625 86.891,69.625 71.697,54.625 52.613,54.625 52.613,72.746 68.613,88.548" fill={color} stroke="none" />
      <polygon
